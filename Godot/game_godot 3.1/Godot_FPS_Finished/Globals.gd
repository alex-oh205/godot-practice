...
var audio_clips = {
	...
	"rifle_shot":preload("res://assets/gun_submachine_auto_shot_00_automatic_preview_01.wav"),
	"gun_cock":preload("res://assets/gun_semi_auto_rifle_cock_02.wav"),
	"grenade_explode":preload("res://assets/explosion_med_long_tail_01.wav"),
}
